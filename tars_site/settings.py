...
# Set EMAIL_BACKEND env var to 'smtp' to switch to SMTP in production.
...
DEFAULT_FROM_EMAIL = os.environ.get("TARS_FROM_EMAIL", "TARS <noreply@tars.ai>")
TARS_ADMIN_EMAIL = os.environ.get("TARS_ADMIN_EMAIL", "admin@tars.ai")
